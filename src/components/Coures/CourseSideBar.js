...
const CourseSideBar = () => {
    return (
        <div>
            <h2 className='text-center font-bold md:text-5xl mt-3'>Course Overview</h2>
            <section className="p-4 my-6 md:p-8  text-gray-100">
                <div className="container grid grid-cols-1 gap-6 m-4 mx-auto md:m-0 md:grid-cols-2 xl:grid-cols-3">
                    <div className="flex overflow-hidden rounded-lg bg-gray-900 text-gray-100">
                        ...
                        <div className="flex md:flex-col items-center justify-between flex-1 p-3">
