...
const Login = () => {
    ...
    const {googleLogin , signIn, gitLogin} = useContext(AuthContext);
    ...
    return (
        <div className='bg-gray-900 h-screen flex justify-center '>
            <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 mt-10 text-gray-100">
                ...
                <div className="my-6 space-y-4">
                    ...
                    <button onClick={handleGitHubLogin} aria-label="Login with GitHub" role="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 border-gray-400 focus:ring-violet-400">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
                ...
                <form onSubmit={handleSubmit} novalidate="" action="" className="space-y-8 ng-untouched ng-pristine ng-valid">
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <input type="password" name="password" id="password" placeholder="Your Password" className="w-full px-3 py-2 border rounded-md border-gray-700 bg-gray-900 text-gray-100 focus:border-violet-400" />
                        </div>
                        <div className="flex justify-between">
                                <label for="password" className="text-sm">Password</label>
                                <Link rel="noopener noreferrer" to='/signup' className="text-xs hover:underline text-gray-400">Don't have account? Sign up</Link>
                            </div>
                    </div>
                    <div>
